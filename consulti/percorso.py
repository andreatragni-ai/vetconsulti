...
def passo_2_completo(richiesta):
    """Esperto referente per il tipo e quesito scritto: cio' che il form del
    passo 2 pretende. L'assenza dell'esperto non conta qui: il riepilogo la
    segnala, e la regola di invio non la guarda."""
