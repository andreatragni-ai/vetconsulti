...
urlpatterns = [
    ...
    path('<int:pk>/integrazioni-fatte/', views.integrazioni_fatte, name='integrazioni_fatte'),
    ...
    path('<int:pk>/integrazione/', views_decisione.chiedi_integrazione, name='chiedi_integrazione'),
